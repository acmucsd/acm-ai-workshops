...
The official ACM AI **CNN and Neural Style Transfer** repository. Here you can find the slides and notebook for the workshop.
...
[![AI School 3](./figures/ai_school_3.png)](https://www.youtube.com/watch?v=cxFQXx8gNJc)
...
workshop-3
    ...
    | -- presentation-resources
        | -- slides_ai_school_3.pdf
    | -- ai_school_3_wiki.ipynb
    | -- README.md
...
We’ll learn about deep learning — convolutional layers & receptive field — alongside transfer learning. And to top it off, you’ll get hands-on experience with an neural style transfer project!

You can find the workshop resources here:
- [Presentation](./presentation-resources/slides_ai_school_3.pdf)
- [Jupyter Notebook](./ai_school_3_wiki.ipynb)
- [Solutions Collab](https://acmurl.com/aischool3-solution)
